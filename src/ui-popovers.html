...
<head>
    @@include("partials/title-meta.html", {"title": "Popover"})
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <main>
                ...
                @@include("partials/page-title.html", {"subtitle":"Apps","title":"Popover"})
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="hs-tooltip [--trigger:hover] sm:[--placement:right] inline-block">
                                <div
                                    class="hs-tooltip-toggle max-w-xs p-3 flex items-center gap-x-3 bg-white border border-default-200 rounded-xl shadow-sm">
                                    <img class="inline-block size-9 rounded-full" src="assets/images/users/avatar-1.jpg"
                                    ...
                                    <!-- Popover Content -->
                                    <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-10 max-w-xs w-full bg-white border border-default-100 text-start rounded-xl shadow-md after:absolute after:top-0 after:-start-4 after:w-4 after:h-full"
                                        role="tooltip">
                                        <!-- Header -->
                                        <div class="py-3 px-4 border-b border-default-200">
                                            <div class="flex items-center gap-x-3">
                                                ...
                                                <div class="grow">
                                                    <h4 class="font-semibold text-default-800">
                                                        Amanda Harvey
                                                        <span
                                                            class="ms-0.5 inline-flex items-center align-middle gap-x-1.5 py-0.5 px-1.5 rounded-md text-[11px] font-medium bg-default-800 text-white">
                                                            PRO
                                                        </span>
                                                    </h4>
                                        ...
                                        <ul class="py-3 px-4 space-y-1">
                                            <li>
                                                <div class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                            ...
                                            <li>
                                                <div class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                                    <i class="i-tabler-device-mobile text-base text-default-600"></i>
                                                    (892) 312-5483
                                                </div>
                                            </li>
                                        ...
                                        <!-- Footer -->
                                        <div class="py-2 px-4 flex justify-between items-center bg-default-100">
