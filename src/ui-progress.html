            ...
            <main>
                ...
                <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex w-full h-1.5 bg-default-200 rounded-full overflow-hidden ">
                                <div class="flex flex-col justify-center overflow-hidden bg-primary" role="progressbar"
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex space-x-8">
                                <div
                                    class="flex flex-col flex-nowrap justify-end w-2 h-32 bg-default-200 rounded-full overflow-hidden">
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex w-full h-1.5 bg-default-200 rounded-full overflow-hidden">
                                <div class="flex flex-col justify-center overflow-hidden bg-primary-400" role="progressbar"
                                    style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                <div class="flex flex-col justify-center overflow-hidden bg-primary-700" role="progressbar"
                                    style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                <div class="flex flex-col justify-center overflow-hidden bg-default-800"
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex flex-col items-center justify-center gap-3">
                                ...
                                <div class="w-full h-4 bg-black/10 rounded-full">
                                    <div class="bg-primary-600 h-4 rounded-full w-5/12 animate-strip"
                                        style="background-image:linear-gradient(45deg,hsla(0,0%,100%,.15) 25%,transparent 0,transparent 50%,hsla(0,0%,100%,.15) 0,hsla(0,0%,100%,.15) 75%,transparent 0,transparent);background-size:1rem 1rem">
                                    </div>
                                </div>
                                <div class="w-full h-4 bg-black/10 rounded-full">
