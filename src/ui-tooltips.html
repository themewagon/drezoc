...
<head>
    @@include("partials/title-meta.html", {"title": "Tooltip"})
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <main>
                ...
                @@include("partials/page-title.html", {"subtitle":"Components","title":"Tooltip"})
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <div class="hs-tooltip  [--placement:right]">
                                    ...
                                    <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-default-900 text-xs font-medium text-white rounded shadow-sm"
                                        role="tooltip">
                                        Right Tooltip
                                    </div>
                                </div>
